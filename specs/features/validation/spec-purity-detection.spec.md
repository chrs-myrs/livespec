...
```markdown
# specs/strategy/policy-resolution.spec.md
...
```markdown
# specs/strategy/policy-resolution.spec.md (lines 137-144)
...
- **Location**: specs/strategy/policy-resolution.spec.md:137-144
...
```markdown
# specs/interfaces/api/user-endpoint.spec.md
