...
```yaml
# specs/features/caching.spec.md
...
**Fix**: Create specs/features/caching.spec.md implementing requirement
...
ERROR: Spec without purpose traceability
  File: specs/features/caching.spec.md
...
ERROR: Implementation without spec
  ...
  Fix: Create specs/features/caching.spec.md
```
