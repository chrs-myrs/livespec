...
- **Verdict**: Should be in specs/strategy/ or specs/features/
- **Remediation**: Move to specs/strategy/project-classification.spec.md
...
- **Remediation**: Move to specs/strategy/lambda-architecture.spec.md
...
- Suggests: "Move to specs/features/authentication.spec.md"
...
- Remediation: "Move product taxonomy to specs/strategy/project-classification.spec.md"
...
- Suggests: "Move to specs/strategy/architecture.spec.md"
...
**Remediation mapping:**
- Feature requirements → `specs/features/`
- Feature behaviors → `specs/features/`
- Architecture decisions → `specs/strategy/`
- Strategic outcomes → `specs/foundation/`
