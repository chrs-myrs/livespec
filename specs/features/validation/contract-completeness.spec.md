...
- [!] System validates that every parameter in contract specifications has a corresponding behavior specification reference.
  - Scans all files in `specs/interfaces/` recursively
...
```markdown
---
# specs/interfaces/mcp-tools/slack-tools.spec.md
satisfies:
  - specs/features/slack-messaging.spec.md
---
...
- `channel` (required): Slack channel ID
  - Behavior: specs/features/slack-messaging.spec.md#channel-resolution
- `text` (required): Message text
  - Behavior: specs/features/slack-messaging.spec.md#message-formatting
- `thread_ts` (optional): Thread timestamp for replies
  - Behavior: specs/features/slack-threading.spec.md#thread-replies
...
ERROR: Contract parameter without behavior spec:
  File: specs/interfaces/mcp-tools/slack-tools.spec.md
