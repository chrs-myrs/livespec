...
- **Outputs**: PURPOSE.md, specs/foundation/outcomes.spec.md, specs/foundation/constraints.spec.md, specs/workspace/

### Phase 1: DESIGN
- **Purpose**: Design solution architecture
- **Entry**: Problem and constraints defined
- **Exit**: Architecture and contracts specified
- **Outputs**: specs/features/, specs/interfaces/ (if needed)
