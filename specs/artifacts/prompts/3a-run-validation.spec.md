...
- [!] Prompt actively verifies Phase 2 prerequisites before proceeding, preventing validation without implementation.
  ...
  - Checks specs/features/ exists (if missing → guide to 1b-define-behaviors)
...
- specs/features/ exists (behaviors to validate)
- specs/interfaces/ exists if applicable (contracts to verify)
- specs/foundation/constraints.spec.md exists (constraints to check)
