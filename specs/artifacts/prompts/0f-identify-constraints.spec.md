...
- [!] Prompt guides AI agent to document hard constraints (technical, business, domain) that cannot be negotiated, distinguishing real constraints from preferences and goals.
  - Produces `specs/foundation/constraints.spec.md` (format: MSL with criticality, failure_mode, Requirements listing non-negotiable boundaries)
...
- `specs/foundation/constraints.spec.md` - Non-negotiable project boundaries (format: MSL with hard constraints, each with validation criteria and failure consequences)
