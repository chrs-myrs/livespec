...
- [!] Prompt actively verifies Phase 0 and Phase 1 prerequisites before proceeding, preventing premature implementation.
  ...
  - Checks specs/features/ directory exists with behavior specs (if missing → guide to 1b-define-behaviors)
...
- specs/features/ exists (defines WHAT to build)
- specs/strategy/architecture.spec.md exists (system structure)
- specs/foundation/constraints.spec.md exists (boundaries to respect)
- specs/interfaces/ exists if external interfaces (API contracts)
