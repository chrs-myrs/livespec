...
1. Read behavior spec (specs/features/*.spec.md)
...
```
specs/features/folder-structure.spec.md
...
**Validation (specs/strategy/validation.spec.md)** = Continuous verification
