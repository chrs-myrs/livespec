...
---
satisfies:
  - specs/features/loan-accuracy.spec.md  # Unchanged
guided-by:
  - specs/strategy/python-calculation-approach.spec.md   # Old strategy
---

# Go implementation (after replatform)
---
satisfies:
  - specs/features/loan-accuracy.spec.md  # Same requirements!
guided-by:
  - specs/strategy/go-calculation-approach.spec.md       # New strategy
---
```
...
satisfies:                          # Direct link to requirements (WHAT)
  - specs/features/transaction-accuracy.spec.md
  - specs/features/idempotency.spec.md
guided-by:                          # Guidance from strategy (HOW)
  - specs/strategy/api-design.spec.md
  - specs/strategy/data-consistency.spec.md
criticality: CRITICAL
...
2. **Strategy layer** (`specs/strategy/`)
...
3. **Implementation layer** (`specs/features/`, `specs/interfaces/`)
