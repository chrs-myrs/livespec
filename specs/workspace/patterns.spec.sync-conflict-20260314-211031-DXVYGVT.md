...
## Requirements
- LiveSpec follows strict patterns: MSL format for all specs (.spec.md extension with title, frontmatter, Requirements section), one spec per behavior, workspace/strategy separation in folder structure, and YAML frontmatter declaring specification dependencies.
  ...
  - specs/strategy/ contains cross-cutting technical decisions
  ...
  - Context regeneration via /livespec:audit skill

## Cross-Cutting Development Standards (Strategy References)

Workspace patterns reference cross-cutting development standards defined in strategy layer:
...
- Plugin provides methodology (skills, templates, guides)
- Projects generate context (CLAUDE.md, AGENTS.md, ctxt/)
- Template architecture (plugin reads at runtime)
- Reference Library pattern (skills load detailed guides)
...
- DELETE the spec file: `git rm specs/features/old-spec.spec.md`
