---
derives-from:
  - specs/1-requirements/strategic/outcomes.spec.md (Voluntary Adoption)
  - specs/workspace/constitution.spec.md (Dogfooding principle)
governed-by:
  - specs/1-requirements/strategic/constraints.spec.md (Testable Behaviors, No Framework Lock-in)
...
- Detailed testing strategy in specs/2-strategy/validation.spec.md
