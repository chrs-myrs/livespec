...
specs/workspace/patterns.spec.md (pointer)
  ↓ references
specs/strategy/markdown-standards.spec.md (content)
  ↓ generates
...
**From `specs/strategy/markdown-standards.spec.md`**:
```markdown
# In DEVELOPMENT.md
...
[See specs/strategy/markdown-standards.spec.md for complete details]
```

**From `specs/strategy/testing-approach.spec.md`**:
```markdown
# In DEVELOPMENT.md
...
[See specs/strategy/testing-approach.spec.md for complete details]
```
...
This document provides guidelines for contributing to this project. For complete specifications, see specs/strategy/.
...
**Complete spec**: [specs/strategy/markdown-standards.spec.md](../specs/strategy/markdown-standards.spec.md)
...
**Complete spec**: [specs/strategy/testing-approach.spec.md](../specs/strategy/testing-approach.spec.md)

## Coding Standards

[Generated from specs/strategy/coding-standards.spec.md if it exists]
...
2. For each referenced spec in specs/strategy/:
...
STRATEGY_REFS=$(grep -oP 'specs/strategy/[\w-]+\.spec\.md' specs/workspace/patterns.spec.md)
...
For authoritative requirements, see specs/strategy/.
...
*This document summarizes development standards. For authoritative requirements, see strategy specs in specs/strategy/.*
EOF
```
...
- PURPOSE.md (vision)
- specs/foundation/outcomes.spec.md (what it does)
...
- **Source**: specs/strategy/testing-approach.spec.md, specs/strategy/coding-standards.spec.md
...
- **Source**: specs/strategy/architecture.spec.md, specs/strategy/layer-definitions.spec.md
...
### 3. API Style Guide
- **Source**: specs/strategy/api-design.spec.md, specs/interfaces/api/
...
workspace/patterns.spec.md (curator)
  → references → strategy/*.spec.md (authority)
