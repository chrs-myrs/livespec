...
flowchart TD
    ...
    FileType -->|API/interface| Contract[interfaces/<br/>Interface spec]

    HasBehavior -->|Yes| Behavior[features/<br/>Behavior spec]
    HasBehavior -->|No utility| Utility[features/<br/>Still needs spec]

    ConfigType -->|Project settings| WorkspaceConfig[interfaces/<br/>Config contract]
    ConfigType -->|Data format| DataContract[interfaces/<br/>Schema contract]

    DocType -->|Process/how-to| DocBehavior[features/documentation/<br/>What docs must contain]
    DocType -->|Reference| DocContract[interfaces/<br/>Doc structure]
...
**✅ Correct approach**:
- **Spec**: `specs/features/documentation/faq.spec.md`
...
**✅ Correct approach**:
- **Spec**: `specs/interfaces/configs/eslint-config.spec.md`
...
**✅ Correct approach**:
- **Spec**: `specs/features/utils/string-helpers.spec.md`
...
- ✅ Still create `specs/interfaces/configs/package-json.spec.md`
...
- ✅ Create `specs/features/deployment.spec.md`
...
|----------|-----------|----------|-------------------|
| **Source Code** | Behavior | `features/` | Observable outcomes, not implementation |
| **API endpoints** | Contract + Behavior | `interfaces/api/` + `features/` | Interface + what it does |
| **Configuration** | Contract | `interfaces/configs/` | Schema, required fields |
| **Documentation** | Behavior | `features/documentation/` | What docs must contain/achieve |
| **Scripts** | Behavior | `features/automation/` | What script accomplishes |
| **Tests** | Behavior | Covered by code spec | Tests validate behavior specs |
| **Data schemas** | Contract | `interfaces/data/` | Structure, validation rules |
...
```yaml
# specs/features/documentation/faq.spec.md
---
satisfies:
  - specs/features/user-support.spec.md
...
```yaml
# specs/interfaces/configs/eslint-config.spec.md
---
governed-by:
  - specs/workspace/patterns.spec.md
criticality: IMPORTANT
...
```yaml
# specs/features/utils/string-normalization.spec.md
---
satisfies:
  - specs/features/data-consistency.spec.md
criticality: IMPORTANT
...
flowchart TD
    ...
    F -->|Code/script| G[features/<br/>Behavior spec]
    F -->|API/interface| H[interfaces/<br/>Contract spec]
    F -->|Config| I[interfaces/configs/<br/>Config spec]
    F -->|Docs| J[features/documentation/<br/>Doc behavior spec]
