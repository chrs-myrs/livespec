...
3. Create requirements specs (specs/foundation/)
...
5. Add UX flow specs to specs/features/ux-flows/
...
**Pattern**:
```markdown
# Contract: specs/interfaces/mcp-tools/slack-tools.spec.md
...
1. Create domain model spec in specs/features/domain-models/
...
specs/foundation/      # WHY you're building (strategic outcomes, constraints)
specs/strategy/          # HOW you'll build (architecture, design decisions)
specs/features/         # WHAT system does (observable outcomes)
specs/interfaces/         # Interfaces (API/data contracts)
...
**What should have been done**: Constraint in specs/foundation/constraints.spec.md
