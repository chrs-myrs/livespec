...
- IN (deliverable) → specs/foundation/, strategy/, or features/
```
...
**Correct location**: `specs/strategy/project-classification.spec.md`
...
- TMP taxonomy dimensions → specs/strategy/
- Policy validation system → specs/features/
```
...
Q: Is this ABOUT the workspace?
A: NO (describes product architecture) → specs/strategy/lambda-architecture.spec.md
```

```markdown
# Spec: "Projects classified by Nature/Type/Deployment"
Q: Is this ABOUT the workspace?
A: NO (describes a product feature) → specs/strategy/project-classification.spec.md
```
...
**Fix**:
- Move to `specs/features/authentication.spec.md`
...
**Should have been**:
- Product taxonomy → `specs/strategy/project-classification.spec.md`
