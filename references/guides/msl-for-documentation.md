...
---
satisfies:
  - specs/foundation/developer-productivity.spec.md
...
```yaml
# specs/features/documentation/architecture-overview.spec.md
---
satisfies:
  - specs/foundation/developer-onboarding.spec.md
...
```yaml
# specs/features/documentation/api-reference.spec.md
---
satisfies:
  - specs/features/api-integration.spec.md
criticality: CRITICAL
...
```yaml
# specs/features/documentation/incident-runbooks.spec.md
---
satisfies:
  - specs/foundation/operational/incident-response.spec.md
criticality: CRITICAL
...
```yaml
# specs/features/documentation/getting-started-guide.spec.md
---
satisfies:
  - specs/foundation/user-activation.spec.md
criticality: IMPORTANT
...
foundation/outcomes.spec.md
    ...
    ↓ derives-from
strategy/documentation-approach.spec.md
    ("Progressive disclosure", "Task-oriented structure")
    ↓ satisfies (WHAT) + guided-by (HOW)
features/documentation/architecture-docs.spec.md
