...
```
specs/features/models/[concept-name].spec.md
```

Examples:
- `specs/features/models/threading.spec.md`
- `specs/features/models/payment-state-machine.spec.md`
- `specs/features/models/session-lifecycle.spec.md`
...
```yaml
# In specs/features/slack-messaging.spec.md
---
uses-models:
  - specs/features/models/threading.spec.md
  - specs/features/models/correlation.spec.md
---
```
