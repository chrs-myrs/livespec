---
implements: specs/artifacts/prompts/2b-create-tests.spec.md
...
- [ ] `specs/features/` directory with behavior specs - What to test
...
- Missing workspace workflows → "Use `/livespec:design` to define testing patterns first"
...
**Example**:
```python
# From specs/features/authentication.spec.md
