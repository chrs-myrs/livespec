---
implements: specs/artifacts/prompts/2a-implement-from-specs.spec.md
...
- [ ] `specs/foundation/outcomes.spec.md` - High-level requirements
- [ ] `specs/foundation/constraints.spec.md` - Boundaries and limits
- [ ] `specs/workspace/` directory - Workspace constitution, patterns, workflows

**Check Phase 1 artifacts exist:**
- [ ] `specs/features/` directory with behavior specs - What to build
...
**Example**:
```python
# 1. Read spec: specs/features/user-auth.spec.md
...
**Example:**
```yaml
# In specs/features/authentication.spec.md
## Requirements
...
# Spec note added: specs/features/password-hashing.spec.md
...
- Follows specs/features/authentication.spec.md
