---
implements: specs/artifacts/prompts/0c-define-outcomes.spec.md
...
Create `specs/foundation/outcomes.spec.md` that defines high-level project outcomes derived from PURPOSE.md.
