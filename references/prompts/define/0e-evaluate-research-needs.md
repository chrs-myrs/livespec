---
implements: specs/artifacts/prompts/0e-evaluate-research-needs.spec.md
...
- `specs/foundation/outcomes.spec.md` - Review requirements
- `specs/foundation/complexity-assessment.md` - Understand complexity
