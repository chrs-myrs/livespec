---
implements: specs/artifacts/prompts/0a-quick-start.spec.md
phase: 0-define
...
- ❌ Product architecture → specs/strategy/architecture.spec.md
- ❌ Feature behaviors → specs/features/[feature].spec.md
- ❌ API contracts → specs/interfaces/api/[endpoint].spec.md
...
- [!] This project defines what content populates agent contexts.
  ...
  - Key behaviors from specs/features/ relevant to daily work
  ...
  - Behaviors: 40% - Observable outcomes from specs/features/
