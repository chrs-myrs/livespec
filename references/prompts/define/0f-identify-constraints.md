---
implements: specs/artifacts/prompts/0f-identify-constraints.spec.md
...
**Prerequisites**: PURPOSE.md and specs/foundation/outcomes.spec.md exist
**Context**: See `specs/foundation/constraints.spec.md` (LiveSpec's own constraints) as example

## Task

Create `specs/foundation/constraints.spec.md` that defines non-negotiable boundaries for this project.
