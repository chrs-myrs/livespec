---
implements: specs/artifacts/prompts/0c-define-problem.spec.md
...
|----------------------|----------|
| Regulatory/legal requirements | `specs/foundation/constraints.spec.md` |
| Specific measurable outcomes | `specs/foundation/outcomes.spec.md` |
| Technology choices | `specs/strategy/architecture.spec.md` |
