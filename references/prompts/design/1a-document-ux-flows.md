---
implements: specs/artifacts/prompts/1a-document-ux-flows.spec.md
phase: 1-DESIGN
...
---
informed-by:
  - specs/features/[requirement].spec.md
created: YYYY-MM-DD
...
**FR-18: Bug Investigation via Thread URL** (`specs/features/slack-integration.spec.md`)
...
**FR-19: Thread Message Retrieval** (`specs/features/slack-integration.spec.md`)
...
```yaml
# In specs/features/slack-integration.spec.md
---
informed-by:
