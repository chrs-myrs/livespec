---
implements: specs/artifacts/prompts/utils-validate-spec-purity.spec.md
...
| API response example | ✅ NO | Keep if in interfaces/ |
...
**File**: `specs/strategy/policy-resolution.spec.md:137-144`
...
**File**: `specs/interfaces/api/user-endpoint.spec.md`
...
**Location**: interfaces/ (interfaces expected)
...
- ❌ `specs/foundation/` - Pure WHAT (strategic outcomes)
- ❌ `specs/strategy/` - Architectural HOW (not implementation HOW)

**Where examples are acceptable:**
- ✅ `specs/interfaces/` - Interface definitions (API schemas, data contracts)
...
- Found: `specs/strategy/policy-resolution.spec.md:137-144` contains Python caching implementation
