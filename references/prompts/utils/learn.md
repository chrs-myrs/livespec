...
2. [Brief description of learning 2]
   ...
   - Likely target: specs/strategy/[spec].spec.md
...
Options:
  ...
  - label: "[Learning 2 brief]"
    description: "Updates specs/strategy/[spec].spec.md"
  - label: "[Learning 3 brief]"
    description: "Updates specs/features/[spec].spec.md"
...
| [Learning 2] | specs/strategy/architecture.spec.md | Clarify Y approach |
```
