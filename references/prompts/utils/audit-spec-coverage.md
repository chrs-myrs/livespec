---
implements: specs/features/slash-command-generation.spec.md
phase: utilities
---
...
- Example: `scripts/validate.sh` → `specs/features/validation.spec.md`

**Category B: Related group (can share spec)**
- Multiple files serving same purpose
- Configuration files
- Related utilities
- Example: `.gitignore`, `.dockerignore` → `specs/features/project-config.spec.md`
...
### [filename] → specs/features/[suggested-name].spec.md
...
### [file1], [file2], [file3] → specs/features/[group-name].spec.md
...
```markdown
## Create Spec: specs/features/[name].spec.md
