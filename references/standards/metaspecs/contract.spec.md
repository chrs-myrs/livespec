...
- [!] Contract specifications define precise interfaces between any components.
  ...
  - Spec located in `specs/interfaces/` folder or subfolder
...
Contract specs go in target project's `specs/interfaces/` folder or subfolders. Optional - only needed for projects with interfaces between components.
