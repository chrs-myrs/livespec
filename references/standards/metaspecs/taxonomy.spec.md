...
**File**: `specs/features/documentation/architecture-docs.spec.md`
...
guided-by:
  - specs/strategy/documentation-approach.spec.md
specifies:
...
PURPOSE.md: "Enable developer onboarding"
    ↓
foundation/outcomes.spec.md: "Developers understand arch in 2hrs"
    ↓
features/architecture-docs.spec.md: "Docs contain components, data flow, integrations"
    ↓
