...
- [!] Outcomes specification captures high-level project requirements (what must be achieved) that behaviors and architecture must satisfy.
  ...
  - Spec located at `specs/foundation/outcomes.spec.md`
  ...
  - Behaviors in `specs/features/` should trace back to these outcomes
...
specs/strategy/architecture.spec.md (how - technical approach)
    ↓ implements
specs/features/*.spec.md (what - detailed behaviors)
```

Outcomes spec goes in target project's `specs/foundation/` folder.
