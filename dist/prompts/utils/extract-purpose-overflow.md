---
implements: specs/3-artifacts/prompts/utils-extract-purpose-overflow.spec.md
phase: utilities
...
|--------------|----------------|
| Regulatory/compliance requirements | `specs/1-requirements/strategic/constraints.spec.md` |
| Specific measurable outcomes | `specs/1-requirements/strategic/outcomes.spec.md` |
| Technology decisions | `specs/2-strategy/architecture.spec.md` |
...
```bash
ls specs/1-requirements/strategic/constraints.spec.md
ls specs/1-requirements/strategic/outcomes.spec.md
ls specs/2-strategy/architecture.spec.md
```
